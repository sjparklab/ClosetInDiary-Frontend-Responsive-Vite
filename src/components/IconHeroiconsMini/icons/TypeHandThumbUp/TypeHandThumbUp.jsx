...
export const TypeHandThumbUp = ({ className }) => {
  return (
    <svg
      className={`type-hand-thumb-up ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 20 20"
      width="20"
