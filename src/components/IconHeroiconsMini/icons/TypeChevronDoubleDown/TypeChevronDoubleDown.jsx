...
export const TypeChevronDoubleDown = ({ className }) => {
  return (
    <svg
      className={`type-chevron-double-down ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 20 20"
      width="20"
