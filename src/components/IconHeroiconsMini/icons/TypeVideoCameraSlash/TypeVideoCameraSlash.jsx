...
export const TypeVideoCameraSlash = ({ className }) => {
  return (
    <svg
      className={`type-video-camera-slash ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 20 20"
      width="20"
    ...
    >
      <path
        className="path"
        d="M1 13.75V7.18198L9.81802 16H3.25C2.00736 16 1 14.9926 1 13.75Z"
        fill="#626262"
      />

      <path
        className="path"
        d="M13 6.25V12.818L4.18198 4H10.75C11.9926 4 13 5.00736 13 6.25Z"
        fill="#626262"
      />
